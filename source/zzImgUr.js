/*! 
 * jQuery plugin zzImgUr ver 1.4 by zzbaivong
	...
	$.fn.zzImgUr = function (options) {
		var settings = $.extend({
			...
			lang: {
				...
				errContact: '<a href="http://devs.forumvi.com/t131-plugin-jquery-plugin-zzimgur#831" rel="nofollow" target="_blank">Nhấn vào đây</a> để báo lỗi.',
		...
		return this.each(function (index, obj) {
			$(this, obj).html('<div class="imgur_Zzbv" style="width: ' + settings.width + '"> <div class="imgur_Zzbv-control"> <div class="imgur_Zzbv-mode"></div> <div class="imgur_Zzbv-status"> <img src="' + settings.loadding + '" alt="loading..." /> </div> <div class="imgur_Zzbv-upload-computer imgur_Zzbv-add"> <div class="imgur_Zzbv-iconSelect"></div> <div class="imgur_Zzbv-textSelect">' + settings.lang.addImage + '</div> <input type="file" class="imgur_Zzbv-choose" multiple /> </div> <div class="imgur_Zzbv-upload-URL imgur_Zzbv-add"> <div class="imgur_Zzbv-iconSelect"></div> <div class="imgur_Zzbv-textSelect">' + settings.lang.addURL + '</div> </div> <div class="imgur_Zzbv-length"> <span class="imgur_Zzbv-complete">0</span> / <span class="imgur_Zzbv-selected">0</span> </div> <div class="imgur_Zzbv-button"> <div class="imgur_Zzbv-reset">' + settings.lang.reset + '</div> <div class="imgur_Zzbv-upload">' + settings.lang.upload + '</div> </div> <a class="imgur_Zzbv-devs-icon" target="_blank" href="http://devs.forumvi.com/"> <img alt="devs icon" src="http://i56.servimg.com/u/f56/18/59/49/93/l111.png" /> </a> </div> <div class="imgur_Zzbv-preview"> <div class="imgur_Zzbv-list"></div> </div> </div>');
			...
			list.on("input", ".imgur_Zzbv-imageURL", function () {
				...
				if (/^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?[\w-]\.(jpg|png|gif|jpeg|bmp|apng|tiff|xcf)$/i.test(_val) && !$(".imgur_Zzbv-image img[src='" + _val + "']", obj).length) {
				...
				reader.onload = function (_file) {
					...
					image.onload = function () {
						...
						if (!$(".imgur_Zzbv-image img[src='" + _im + "']", obj).length) {
							...
							li_count();
							if ($(".imgur_Zzbv-progress", obj).length > 10) {
								$(".imgur_Zzbv-li:gt(9)", obj).remove();
							}
							selected.text($(".imgur_Zzbv-progress", obj).length);
						}
						up_length();
			...
			function upComp() {
				select_length();
				if (complete.text() == selected.text()) {
					reset.fadeIn();
				}
			}
